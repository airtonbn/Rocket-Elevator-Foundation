Trestle.admin(:intervention) do
    menu do
      group :intervention, priority: :last do
        item :intervention, icon: "fa fa-tachometer"
      end
    end
    ...
    def create
      ...
      @intervention.author_id = session[:user]
      ...
      @intervention.repport = params[:repport]
      @intervention.results = "Incomplete"
      ...
      ZendeskAPI::Ticket.create!($client,
        ...
        :comment => " Ticket author_id: #{@intervention.author_id}.
                      ...
                      Description: #{@intervention.repport}",
        :type => "problem"
