...
;(function($, window, document, undefined) {
  ...
  $.jribbble.employees = function(id) {
    var resource = 'employees';
    var resourceId = checkId(id, resource);
    var Employees = resourceWithoutOpts.call(this, resource);

    Employees.prototype = createSubResources.call(this, [
      'buckets',
      'followers',
      'following',
      'likes',
    ...
    Employees.prototype.isFollowing = function(targetUser) {
      this.queue.add(function(self) {
    ...
    return new Employees(resourceId);
  };
